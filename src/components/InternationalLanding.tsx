        ...
        <div className="bg-[#064E3B] text-white rounded-3xl p-8 sm:p-10 relative overflow-hidden shadow-xl border border-[#064E3B]/30 bg-islamic-pattern mb-10">
          <div className="relative z-10 max-w-3xl space-y-4">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-3">
              ...
              <a
                href={`https://wa.me/923274496163?text=Assalam-o-Alaikum%20Noor%20E%20Quran%20Institute.%20I%20am%20inquiring%20for%20classes%20in%20${encodeURIComponent(data.name)}.`}
                target="_blank"
                rel="noreferrer"
