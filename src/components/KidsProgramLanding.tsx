          ...
          <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                ...
                <a
                  href="https://wa.me/923274496163?text=Assalam-o-Alaikum%20Al-Noor%20Quran%20Academy.%20I%20want%20to%20inquire%20about%20Quran%20classes%20for%20my%20child."
                  target="_blank"
                  rel="noreferrer"
            ...
            <div className="lg:col-span-5 relative group rounded-3xl overflow-hidden border-2 border-[#D4A72C]/40 shadow-2xl bg-emerald-950">
              <img
                ...
                alt="Muslim children learning Quran online happily at Al-Noor Academy"
                width={1200}
                height={800}
                loading="lazy"
                decoding="async"
        ...
        <div className="mb-14">
          <div className="text-center max-w-2xl mx-auto mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-heading font-extrabold text-[#064E3B] mt-2">
              Why Parents Choose Al-Noor for Their Children
            </h2>
          </div>
