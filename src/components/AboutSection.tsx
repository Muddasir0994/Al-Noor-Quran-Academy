      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                Founded with a sacred vision, <strong>Al-Noor Quran Academy</strong> bridges the gap for Muslims living in the West and across the globe who seek authentic, high-caliber Islamic education for their children and themselves.
              </p>
              <p className="text-sm text-gray-700 leading-relaxed">
            ...
            <div className="lg:col-span-5 relative group rounded-3xl overflow-hidden border-2 border-[#D4A72C]/40 shadow-xl bg-emerald-950 aspect-[4/3] sm:aspect-[3/2] lg:aspect-auto lg:h-72 w-full">
              <img
                ...
                alt="Al-Noor Quran Academy library and scholars in traditional study setting"
                width={1200}
                height={800}
                loading="lazy"
                decoding="async"
        ...
        <div className="mb-14">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-heading font-extrabold text-[#064E3B] mt-2">
              The Values Behind Al-Noor Academy
            </h2>
          </div>
